...
// 7 : 
// ce code est utilisé par le service technique afin qu'il puisse ajouter sa décision finale à propos d'une demande et d'effectuer son autorisation pour qu'elle soit signer par le président
public class Main {
	...
	public static void main(String[] args)throws InterruptedException{
	     System.setProperty("webdriver.chrome.driver", "C:\\Selenium\\chromedriver-win64\\chromedriver.exe");
	        ...
	        String filePath = "C:\\Users\\ylach\\Desktop\\cours\\TP_Qazdar\\autorisationSTechnique1.pdf";
